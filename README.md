...
- Codex history rail lists app-server threads by Codex metadata semantics, searches title/preview/cwd/provider/source fields, and resumes selected rows through `thread/resume`.
